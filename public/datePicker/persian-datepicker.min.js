				...
				return a(e, [
					...
					},
					{
						...
						value: function()
						{
							...
							{
								$(i.target).is(e.elem) || $(i.target).is(e.model.view.$container) || 0 != $(i.target)
									.closest("#" + e.model.view.$container.attr("id")).length || $(i.target)
									.is($(e.elem).children()) || (e.model.api.hide(), $("body").unbind("click", t));
							};
							$(this.elem).on("focus click", o.debounce(function(i)
							{
								return e.model.api.show(), !1 === e.model.state.ui.isInline && $("body")
									.unbind("click", t)
									.bind("click", t), o.isMobile && $(this).blur(), i.stopPropagation(), !1;
							}, 200)), $(this.elem).on("keydown", o.debounce(function(t)
							{
								if (9 === t.which)
								{
									return e.model.api.hide(), !1;
								}
							}, 200));
						}
					},
					...
					},
					{
						...
						value: function()
						{
							...
							else
							{
								...
								{
									"unix" === this.model.options.initialValueType && i ? e = parseInt(i) : i && (e = new Date(i).valueOf());
								}
				...
				return a(e, [
					{
						...
						value: function()
						{
							if (this.model.options.navigator.scroll.enabled)
							{
								...
								}), this.model.options.timePicker.enabled && $("#" + e.model.view.id + " .time-segment")
									.each(function()
									{
										o(this).wheel(function(t, i)
										{
											var n = $(t.target),
												a = n.data("time-key") ? n.data("time-key") : n.parents("[data-time-key]")
													.data("time-key");
					...
					},
					{
						...
						value: function(e)
						{
							if (void 0 != this.model.options.timePicker[e])
							{
								...
								"meridian" == e ? (t = 12, i = "PM" == this.model.state.view.meridian ? this.model.PersianDate.date(this.model.state.selected.unixDate)
									.add("hour", t)
									.valueOf() : this.model.PersianDate.date(this.model.state.selected.unixDate)
									.subtract("hour", t)
									.valueOf(), this.model.state.meridianToggle()) : (t = this.model.options.timePicker[e].step, i = this.model.PersianDate.date(this.model.state.selected.unixDate)
									.add(e, t)
									.valueOf()), this.model.state.setViewDateTime("unix", i), this.model.state.setSelectedDateTime("unix", i), this.model.view.renderTimePartial(), clearTimeout(this.scrollDelayTimeDown), this.scrollDelayTimeUp = setTimeout(function()
								{
					...
					},
					{
						...
						value: function(e)
						{
							...
							{
								var t = void 0, i = void 0, n = this;
								"meridian" == e ? (t = 12, i = "AM" == this.model.state.view.meridian ? this.model.PersianDate.date(this.model.state.selected.unixDate)
									.add("hour", t)
									.valueOf() : this.model.PersianDate.date(this.model.state.selected.unixDate)
									.subtract("hour", t)
									.valueOf(), this.model.state.meridianToggle()) : (t = this.model.options.timePicker[e].step, i = this.model.PersianDate.date(this.model.state.selected.unixDate)
									.subtract(e, t)
									.valueOf()), this.model.state.setViewDateTime("unix", i), this.model.state.setSelectedDateTime("unix", i), this.model.view.renderTimePartial(), clearTimeout(this.scrollDelayTimeDown), this.scrollDelayTimeDown = setTimeout(function()
								{
									n.model.view.markSelectedDay();
								}, 300);
							}
					...
					},
					{
						...
						{
							var e = this;
							this.model.options.navigator.enabled && $(document)
								.on("click", "#" + e.model.view.id + " .pwt-btn", function()
								{
									$(this)
										.is(".pwt-btn-next") ? (e.model.state.navigate("next"), e.model.view.render(), e.model.options.navigator.onNext(e.model)) : $(this)
										.is(".pwt-btn-switch") ? (e.model.state.switchViewMode(), e.model.view.render(), e.model.options.navigator.onSwitch(e.model)) : $(this)
										.is(".pwt-btn-prev") && (e.model.state.navigate("prev"), e.model.view.render(), e.model.options.navigator.onPrev(e.model));
								}), this.model.options.timePicker.enabled && ($(document)
								.on("click", "#" + e.model.view.id + " .up-btn", function()
								{
								...
								}), $(document).on("click", "#" + e.model.view.id + " .down-btn", function()
							{
							...
							})), this.model.options.dayPicker.enabled && $(document)
								.on("click", "#" + e.model.view.id + " .datepicker-day-view td:not(.disabled)", function()
								{
								...
								}), this.model.options.monthPicker.enabled && $(document)
								.on("click", "#" + e.model.view.id + " .datepicker-month-view .month-item:not(.month-item-disable)", function()
								{
								...
								}), this.model.options.yearPicker.enabled && $(document)
								.on("click", "#" + e.model.view.id + " .datepicker-year-view .year-item:not(.year-item-disable)", function()
								{
				...
				return a(e, [
					{
						...
						value: function(e)
						{
							...
							}, e = e.toEnglishDigits(), n.test(e) ? e.split(/\/|-|\,|\./)
								.map(Number) : i.test(e) ? e.split(/\/|-|\,|\:|\T|\Z/g).map(Number) : void 0;
						}
					}
				]), e;
			}();
			...
			}(), o    = function()
			{
				...
				return a(e, [
					...
					},
					{
						...
						value: function()
						{
							return this.selected.dateObject = this.model.PersianDate.date([
								this.selected.year,
								this.selected.month,
								this.selected.date,
								this.view.hour,
								this.view.minute,
								this.view.second
							]), this.selected.unixDate = this.selected.dateObject.valueOf(), this.model.updateInput(this.selected.unixDate), this;
						}
					},
					{
						...
						value: function()
						{
							...
							return this.view.date > e && (this.view.date = e), this.view.dateObject = this.model.PersianDate.date([
								this.view.year,
								this.view.month,
								this.view.date,
								this.view.hour,
								this.view.minute,
								this.view.second
							]), this.view.year = this.view.dateObject.year(), this.view.month = this.view.dateObject.month(), this.view.date = this.view.dateObject.date(), this.view.hour = this.view.dateObject.hour(), this.view.hour12 = this.view.dateObject.format("hh"), this.view.minute = this.view.dateObject.minute(), this.view.second = this.view.dateObject.second(), this.view.unixDate = this.view.dateObject.valueOf(), this;
						}
					},
					{
						key: "setViewDateTime",
		...
		}, function(e, t, i)
		{
			...
			}(), r    = i(1), l = i(0), d = i(15), c = function()
			{
				function e(t)
				{
					...
					var i = this;
					return this.model.state.ui.isInline ? this.$container = $('<div  id="' + this.id + '" class="datepicker-container-inline"></div>')
						.appendTo(i.model.inputElement) : (this.$container = $('<div  id="' + this.id + '" class="datepicker-container"></div>')
						.appendTo("body"), this.hide(), this.setPickerBoxPosition(), this.addCompatibilityClass()), this;
				}
				...
				return s(e, [
					...
					},
					{
						...
						value: function()
						{
							...
							if (l.isMobile && this.model.options.responsive)
							{
								return !1;
							}
					...
					},
					{
						...
						value: function(e)
						{
							...
							if (this.model.state.filetredDate)
							{
								...
								if (i && n && (t == o && e > n || t > o) || t == a && e < i || t < a)
								{
									return !1;
								}
								if (n && (t == o && e > n || t > o))
					...
					},
					{
						...
						value: function()
						{
							...
							try
							{
								for (var r, l = i.model.PersianDate.date()
									.rangeName()
									.months
									.entries()[Symbol.iterator](); !(n = (r = l.next()).done); n = !0)
								{
					...
					},
					{
						...
						value: function(e)
						{
							...
							if (t.minDate = this.model.options.minDate, t.maxDate = this.model.options.maxDate, t.model.state.filetredDate)
							{
								...
								{
									if (t.minDate = t.model.PersianDate.date(t.minDate)
											.startOf("day")
											.valueOf(), t.maxDate = t.model.PersianDate.date(t.maxDate)
											.endOf("day")
											.valueOf(), !(e >= t.minDate && e <= t.maxDate))
									{
										return !1;
									}
								}
								...
								else if (t.maxDate && (t.maxDate = t.model.PersianDate.date(t.maxDate)
										.endOf("day")
										.valueOf(), e >= t.maxDate))
								{
									return !1;
					...
					},
					{
						...
						value: function()
						{
							...
							var t                                                               = this.model.state.view.month, i                              = this.model.state.view.year,
								...
								s = n.getFirstWeekDayOfMonth(i, t) - 1, r = [], l = 0, d = 0, c = [
									[
										"null",
										"null",
										"null",
								...
								for (var p, f = c.entries()[Symbol.iterator](); !(h = (p = f.next()).done); h = !0)
								{
									...
									try
									{
										for (var x, P = b.entries()[Symbol.iterator](); !(k = (x = P.next()).done); k = !0)
										{
											...
											0 === y && M < s ? (S = this.model.state.view.dateObject.startOf("month")
												.hour(12)
												.subtract("days", s - M), O = !0) : 0 === y && M >= s || y <= 5 && l < a ? (l += 1, S = new persianDate([
												this.model.state.view.year,
												this.model.state.view.month,
												l
											]), O = !1) : (d += 1, S = this.model.state.view.dateObject.endOf("month")
												.hour(12)
												.add("days", d), O = !0), r[y].push({
												title: S.format("D"),
												alterCalTitle: new persianDate(S.valueOf()).toCalendar(u[0])
													.toLocale(u[1])
													.format("D"),
					...
					},
					{
						...
						value: function()
						{
							...
							{
								$(this).data("date") == [e.year, e.month, e.date].join(",") ? $(this)
									.addClass("selected") : $(this).removeClass("selected");
							});
						}
					},
					{
						...
						value: function()
						{
							...
							{
								$(this).data("date") == [e.year(), e.month(), e.date()].join(",") ? $(this)
									.addClass("today") : $(this).removeClass("today");
							});
						}
					},
					{
					...
					},
					{
						...
						value: function()
						{
							return [
								...
								"gregorian" == this.model.options.calendar_ ? "datepicker-gregorian" : "datepicker-persian"
							].join(" ");
						}
					},
					{
						...
						value: function(e)
						{
							...
							return {
								...
								calendarSwitchText: this.model.state.view.dateObject.toCalendar(t[0])
									.toLocale(t[1])
					...
					},
					{
						...
						value: function()
						{
							...
							return "persian" == e.model.options.calendar_ ? (t = "gregorian", i = e.model.options.calendar.gregorian.locale) : (t = "persian", i = e.model.options.calendar.persian.locale), [
								t,
								i
							];
						}
					},
					{
						...
						value: function()
						{
							...
							this.$container.find('[data-time-key="hour"] input')
								.val(e.hour.title), this.$container.find('[data-time-key="minute"] input')
								.val(e.minute.title), this.$container.find('[data-time-key="second"] input')
								.val(e.second.title), this.$container.find('[data-time-key="meridian"] input')
					...
					},
					{
						...
						value: function(e)
						{
							e || (e = this.model.state.view), l.debug(this, "render"), d.parse(r), this.rendered = $(d.render(this.model.options.template, this.getViewModel(e))), this.$container.empty()
								.append(this.rendered), this.markSelectedDay(), this.markToday(), this.afterRender();
						}
					},
					{
						key: "reRender",
			...
			!function(t, i)
			{
				...
				n.normalise = {
					...
					delta: function(e)
					{
						...
						return e.deltaY && (s = -1 * e.deltaY, i = s), e.deltaX && (n = e.deltaX, i = -1 * n), e.wheelDelta && (i = e.wheelDelta), e.wheelDeltaY && (s = e.wheelDeltaY), e.wheelDeltaX && (n = -1 * e.wheelDeltaX), e.detail && (i = -1 * e.detail), 0 === i ? [
							0,
							0,
							0
						] : (r = Math.abs(i), (!a || r < a) && (a = r), l = Math.max(Math.abs(s), Math.abs(n)), (!o || l < o) && (o = l), t = i > 0 ? "floor" : "ceil", i = Math[t](i / a), n = Math[t](n / o), s = Math[t](s / o), [
							i,
							n,
							s
						]);
		...
		}, function(e, t, i)
		{
			...
			}(0, function(e)
			{
				...
				function d(t, i)
				{
					function a(e)
					{
						if ("string" == typeof e && (e = e.split(g, 2)), !f(e) || 2 !== e.length)
						{
					...
					for (var y, b, T, M, S, O, E = new h(t); !E.eos();)
					{
						if (y = E.pos, T = E.scanUntil(o))
						{
							...
							{
								M = T.charAt($), r(M) ? v.push(m.length) : w = !0, m.push([
									"text",
									M,
									y,
									y + 1
						...
						if (p = !0, b = E.scan(P) || "name", E.scan(k), "=" === b ? (T = E.scanUntil(D), E.scan(D), E.scanUntil(s)) : "{" === b ? (T = E.scanUntil(l), E.scan(x), E.scanUntil(s), b = "&") : T = E.scanUntil(s), !E.scan(s))
						{
				...
				function c(e)
				{
					...
					{
						(t = e[a]) && ("text" === t[0] && i && "text" === i[0] ? (i[1] += t[1], i[3] = t[3]) : (n.push(t), i = t));
					}
					return n;
				}
				...
				}, v.prototype.renderTokens = function(e, t, i, n, a)
				{
					...
					{
						r = void 0, o = e[d], s = o[0], "#" === s ? r = this.renderSection(o, t, i, n) : "^" === s ? r = this.renderInverted(o, t, i, n) : ">" === s ? r = this.renderPartial(o, t, i, a) : "&" === s ? r = this.unescapedValue(o, t) : "name" === s ? r = this.escapedValue(o, t) : "text" === s && (r = this.rawValue(o)), void 0 !== r && (l += r);
					}
					return l;
