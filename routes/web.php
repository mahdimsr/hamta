        ...
        Route::middleware('auth:admin')->namespace('Dashboard')->prefix('admin/dashboard')->group(function()
        {
            ...
            Route::prefix('exams')->group(function()
            {
                ...
                Route::prefix('/lessonToLesson')->group(function()
                {
                    ...
                    Route::get('/edit/{id}', 'LessonExamController@editQuestionShow')->name('admin_ltlExams_editQuestionShow');
                    Route::post('/edit/{id}', 'LessonExamController@editQuestion')->name('admin_ltlExams_editQuestion');
