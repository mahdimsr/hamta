	...
	*/
	...
	'custom' => [
		...
		'username' => [
			...
			'exist'    => 'نام کاربری یا کلمه عبور وارد شده صحیح نمیباشد.',
        ...
        'password_signup' => [
            ...
            'required' => 'کلمه عبور خود را وارد نمایید.',
            'regex'     =>'کلمه عبور باید شامل حروف کوچک و بزرگ به همراه عدد باشد.',
            'min'     =>'کلمه عبور باید حداقل 6 کاراکتر باشد.',
            'confirmed' =>'کلمه عبور وارد شده و تکرار آن همخوانی ندارند.'
