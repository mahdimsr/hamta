		...
		<div class="col-md-5">
			<div class="card ">
				...
				<div class="content">
					...
					<p class="description text-right">
						<b>پارامتر گرایش</b> باید یک کلمه انگلیسی باشد. از پارامتر گرایش در بخش آدرس دهی در مرورگر استفاده
						میکنیم. پس پیشنهاد میشود که پارامتر گرایش یک مفهوم را برساند. برای مثال اگر گرایش مد نظر ریاضی
						فیزیک است بهتر است که پارامتر گرایش Mathematics باشد.
					</p>
					<p class="description text-right">
						<b>عنوان گرایش</b> کلماتی مانند ریاضی فیزیک و تجربی و ... است. شما نباید برای مثال از عبارت رشته
						تحصیلی ریاضی فیزیک و یا رشته تجربی استفاده کنید و فقط عنوان گرایش را بنویسید.
					</p>
					<p class="description text-right justify-content-center">
						<b>مثال</b> <br/> عنوان : تجربی <br/> کد : 02 <br/> پارامتر : Science
					</p>
				</div>
				<hr>
			</div>
			...
			<div class="card text-right">
				...
				<div class="content">
					<form method="post"
                        ...
                        <a href="{{route('admin_orientations')}}" class="btn btn-info pull-left"> بازگشت <span class="fas fa-arrow-left"></span></a>
