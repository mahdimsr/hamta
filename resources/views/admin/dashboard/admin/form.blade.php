			...
			<div class="card ">
				...
				<div class="content">
					...
					<p class="description text-right">
						...
						تعریف نام کاربری از دکمه space استفاده نکنید و بین عبارات فاصله نیندازید.
                    </p>
                    <p class="description text-right">
						<b>سطح دسترسی </b> در این بخش مشخص می شود که ادمین ایجاد شده می تواند به چه بخش هایی از سایت دسترسی داشته باشد ،  که دارای چهار سطح میباشد برای مثال سوپر ادمین میتواند به همه ی بخش های پنل دسترسی داشته باشد .
					</p>
					<p class="description text-right">
