            ...
            <div dir="rtl" class="card ">
                ...
                <div class="content">
                    <form method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-file-container">
                                    ...
                                    <label for="my-file" class="input-file-trigger text-center">
                                        {{$modify == 1 && $lessonExam->answersheet ? 'ویرایش پاسخ نامه تشریحی' : 'آپلود پاسخ نامه تشریحی'}}
                                    </label>
                                </div>
                                <div class="invalid-feedback">
                        ...
                        <a href="{{route('admin_ltlExams')}}" class="btn btn-info pull-left"> بازگشت <span class="fas fa-arrow-left"></span></a>
