...
@section('content')
	...
	<form method="post" action="{{route('admin_ltl_add_many_question')}}">
		...
		<div dir="rtl" class="row">
			<div class="col-md-1">
				<label class="label" style="font-size: 130%">
					<input name="questionId[]" value="1" class="label__checkbox" type="checkbox"/>
					...
					<div class="card-body">
						<div dir="rtl" class="row text-right " style="margin: 0px;">
							<div class="col-md-9 col-lg-10" style="float: right">
								<p>1- جیم لیک دانش‌آموز معمولی دبیرستانی دنبال ماجراجویی است، اما زمانی که غول کش قبلی
									کشته‌
									می‌شود او به صورت تصادفی نشان غول‌کشی را پیدا می‌کند.</p>

								<ul class="answers">
									<li><p>گزینه اول</p></li>
									<li><p>گزینه دوم</p></li>
									<li><p>گزینه سوم</p></li>
									<li><p>گزینه چهارم</p></li>
								</ul>

							</div>
							<div class="col-md-2 " style="float: right;">
								<a href="#"> <img class="question-img" src="{{asset('image/admin/dashboard/test.png')}}"
