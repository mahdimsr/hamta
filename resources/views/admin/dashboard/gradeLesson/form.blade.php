			...
			<div class="card ">
				<div class="content">
                    ...
                    <p class="description text-right">
						<b>گرایش درس </b> مشخص میکند درس ایجاد شده مختص چه گرایشی است .
                    </p>
					...
					<p class="description text-right">
						<b>نوع درس</b> مشخص میکند درس ایجاد شده برای گرایش و مقطع مورد نظر به عنوان درس تخصصی شناخته می شود یا عمومی .
                    </p>
					...
					<p class="description text-right justify-content-center">
						<b>مثال</b> <br/> گرایش: ریاضی و فیزیک  <br/> درس : ریاضی (1) <br/>  مقطع : دهم <br/> نوع : تخصصی<br/> ضریب : 4
					</p>
				</div>
				<hr>
			</div>
