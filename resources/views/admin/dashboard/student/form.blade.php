							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input dir="rtl" type="text" name="name" class="form-control"
										   value="{{ old('name')? old('name') : $student->name }}" required>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input dir="rtl" type="email" name="email" class="form-control"
										   placeholder="پست الکترونیکی خود را وارد نمایید"
										   value="{{ old('email')? old('email') : $student->email }}" required>
							...
							<div class="col-md-8">
								<div class="form-group">
									...
									<input dir="rtl" name="address" type="text" class="form-control"
										   ...
										   value="{{ old('address')? old('address') : $student->address }}" required>
						...
						<div class="row">
							<div class="col-md-1">
								<div class="form-group" style="margin-top:20px;">
									<input dir="rtl" name="averageUp" maxlength="2" type="number" class="form-control"
							...
							<div class="col-md-1">
								<div class="form-group">
									...
									<input dir="rtl" name="averageDown" maxlength="2" type="number" class="form-control"
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input dir="rtl" name="school" type="text" class="form-control"
										   ...
										   value="{{ old('school')? old('school') : $student->school }}" required>
