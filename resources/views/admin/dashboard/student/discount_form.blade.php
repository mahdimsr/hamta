    ...
    <div class="row" dir="rtl">
        ...
        <div class="col-md-8">
            <div class="card text-right">
                <div class="header ">
                    <h4 class="title">{{ $modify==0 ? 'افزودن کد تخفیف اختصاصی دانش آموز' : 'ویرایش کد تخفیف اختصاصی دانش آموز'}}</h4>
                </div>

                <div class="content">

                    <form method="post" action="{{$modify == 0 ? route('admin_students_discountAdd',['id' => $id]) : route('admin_students_discountEdit',['id' => $id,'discountId'=>$discount->id]) }}">
                        {{csrf_field()}}
