...
<hr>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row equal ">
                    <div class="col-md-3  ">
                        <img class="pic-card" src="{{ asset('image/student/dashboard/Scholarship2.jpg') }}" alt="" width="100%" height="100%">
                    </div>
                    <div class="col-md-3  ">
                        <div class="row">
                        <div class="col-md-6" style="padding: 0px 5px 0px 0px;">
                            <img class="pic-card" src="{{ asset('image/student/dashboard/stepbystep-exam1.jpg') }}" alt="" width="100%" height="100%">
                        </div>
                    ...
                    <div class="col-md-6  ">
                        <img class="pic-card" src="{{ asset('image/student/dashboard/stepbystep-exam.jpg') }}" alt="" width="100%" height="100%">
                    </div>
                </div>
