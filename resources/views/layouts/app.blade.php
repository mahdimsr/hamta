...
<head>
	...
	<title>همپا | هدف ما پیشرفت است.</title>
		...
		<nav class="navbar navbar-expand-lg navbar-light">
			<div class="container box_1620">
				<a class="navbar-brand" href="{{route('homepage')}}"><img
							src="{{asset('image/homepage/اصلی.png')}}" alt="" width="100px" height="100px"></a>
				...
				<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
					...
					<ul class="nav-right text-center text-lg-right py-1 py-lg-0">
						...
						<li class="btn btn-outline-primary"><a href="{{ route('student_login_form') }}">دانش آموزان</a></li>
					</ul>
					<ul class="nav-right text-center text-lg-right py-1 py-lg-0">
