                        ...
                        <div class="card cards">
                            ...
                            <ul id="myTab" role="tablist" class="nav nav-tabs nav-pills text-right ">
                                <li class="nav-item active">
                                    <a id="lessonExam-tab" data-toggle="tab" href="#lessonExam" role="tab"
                                       aria-controls="lessonExam" aria-selected="true" class="nav-link   ">درس به
                                        درس</a>
                                </li>
                                <li class="nav-item ">
                                    <a id="giftExam-tab" data-toggle="tab" href="#giftExam" role="tab"
                                       aria-controls="giftExam" aria-selected="false" class="nav-link ">جایزه بگیر</a>
                                </li>

                            </ul>
                            <div id="myTabContent" class="tab-content">
                                <div id="lessonExam" role="tabpanel" aria-labelledby="lessonExam"
